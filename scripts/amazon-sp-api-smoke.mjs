...
const marketplaceId = getEnvVar(`AMAZON_MARKETPLACE_ID_${tenant}`)
const region = getEnvVar(`AMAZON_SP_API_REGION_${tenant}`)
const sellerId = getEnvVar(`AMAZON_SELLER_ID_${tenant}`)
...
if (!marketplaceId) missing.push(`AMAZON_MARKETPLACE_ID_${tenant}`)
