...
## Files Reviewed
- Repo/runtime config: `app-manifest.json`, `dev.local.apps.json`, `plans/2026-04-11-cross-app-ci-smoke-spec.md`, `plans/2026-04-11-plutus-test-plan.md`, `apps/plutus/.env.local`, `apps/plutus/.env.dev.ci`, `apps/plutus/package.json`, `apps/plutus/next.config.ts`, `apps/plutus/README.md`.
...
## Cross-App Notes
- `plans/2026-04-11-cross-app-ci-smoke-spec.md` already proved the local shared-auth topology is drifting away from browser reality. Plutus uses the same env-first pattern that caused SSO callback drift there.
