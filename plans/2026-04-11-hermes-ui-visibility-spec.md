...
## Files Reviewed
- Required context: `app-manifest.json`, `plans/2026-04-11-cross-app-ci-smoke-spec.md`, `plans/2026-04-11-hermes-test-plan.md`
...
## Verification Plan
- Verify `/hermes` still redirects cleanly to `/hermes/insights` and that the shell renders without client exceptions, matching `plans/2026-04-11-cross-app-ci-smoke-spec.md`.
...
## Cross-App Notes
- `plans/2026-04-11-cross-app-ci-smoke-spec.md` shows Hermes currently boots cleanly at `http://localhost:3014/hermes`, redirects to `/hermes/insights`, and can navigate to `/hermes/orders` without console errors.
