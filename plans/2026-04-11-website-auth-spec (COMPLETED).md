...
## Files Reviewed
- Repo/runtime context: `app-manifest.json`, `dev.local.apps.json`, `plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md`, `plans/2026-04-11-website-test-plan.md`, `README.md`.
...
- Smoke-evidenced path: `/` then click `Packs`, matching `plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md`.
...
- From `/` and `/legal/privacy`, click global `Packs`, `Where to buy`, `Support`, and `About`; fail on `ChunkLoadError`, failed JS chunk requests, or unexpected `4xx`/`5xx`, consistent with `plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md`.
