...
## Cross-App Notes
- `plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md` already shows that Plutus is comparatively healthy at boot: `/plutus` redirected to `/plutus/settlements`, `/plutus/settlements` rendered successfully, `/plutus/api/plutus/settlements?page=1&pageSize=25` returned `200`, and `/plutus/transactions` also rendered successfully.
