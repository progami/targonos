...
## Confirmed Issues
- The known homepage-to-packs navigation path is broken by client chunk failures. `plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md` and `plans/2026-04-11-website-test-plan.md` both record that clicking `Packs` from the live homepage produced `ChunkLoadError`, while route chunk requests for `/cs/us/packs`, `/cs/us/where-to-buy`, and `/cs/us/about` returned `400`.
