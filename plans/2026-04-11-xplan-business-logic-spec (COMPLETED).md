...
- `/xplan/1-strategies` is a legacy slug that redirects to `/xplan/1-setup`, matching the smoke evidence in [plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md](/Users/jarraramjad/dev/targonos-main/plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md:85).
...
- Re-run the smoke entry route from [plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md](/Users/jarraramjad/dev/targonos-main/plans/2026-04-11-cross-app-ci-smoke-spec (COMPLETED).md:85) and confirm setup no longer lands in a misleading `No strategies found` state for recoverable backend/config failures.
