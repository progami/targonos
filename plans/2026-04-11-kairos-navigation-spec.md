...
## Files Reviewed
- Runtime and repo routing context: `app-manifest.json`, `dev.local.apps.json`, `plans/2026-04-11-cross-app-ci-smoke-spec.md`, `plans/2026-04-11-kairos-test-plan.md`
