...
- `plans/2026-04-11-cross-app-ci-smoke-spec.md` says `/argus` redirected to `/argus/wpr` and rendered successfully, and `/argus/monitoring` also rendered successfully with no console errors during that pass.
