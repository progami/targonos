          ...
          <div className="cs-section--hero">
            ...
            <Reveal delay={140}>
              <p className="mt-5 max-w-lg text-[1.05rem] leading-relaxed text-white/60 md:text-lg 2xl:max-w-xl 2xl:text-[1.25rem]">
                Pick your coverage. Four pack sizes, one extra large drop cloth. Available exclusively on Amazon.
              </p>
            </Reveal>
            <Reveal delay={200}>
        ...
        <Container className="relative z-10">
          <Reveal>
            ...
            <p className="mx-auto mt-3 max-w-md text-center text-base text-white/45 2xl:text-lg">
              Every drop cloth is 12ft × 9ft. Choose the pack that fits your project.
            </p>
          </Reveal>
      ...
      <section className="cs-section relative overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          <div className="mx-auto mt-14 grid max-w-4xl 2xl:max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: 'Extra Large', desc: 'Every drop cloth is 12ft × 9ft — bigger than standard alternatives.' },
              ...
              { title: 'Pack Options', desc: 'From 1 drop cloth to 12 — pick the size for your project.' },
