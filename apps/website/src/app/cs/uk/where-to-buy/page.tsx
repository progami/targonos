...
function getAmazonLinks(catalog: typeof productsUK) {
...
const comparisonRows = [
  { feature: 'Sheet size', caelum: '12ft x 9ft (extra large)', standard: 'Varies (often smaller)' },
  { feature: 'Recycled content', caelum: '55% recycled plastic', standard: 'Usually 0%' },
  { feature: 'GRS certified', caelum: true, standard: false },
  { feature: 'Coverage per pack', caelum: 'Up to 1080 sq ft', standard: 'Varies' },
          ...
          <div className="cs-section--hero">
            ...
            <Reveal delay={200}>
              <div className="cs-hero-stats mt-10">
                <div className="cs-hero-stat">
                  <span className="cs-hero-stat-value">6</span>
                ...
                <div className="cs-hero-stat">
                  <span className="cs-hero-stat-value">12x9</span>
            ...
            <Reveal delay={280}>
              <div className="mt-10 flex flex-wrap items-center gap-3">
                ...
                >
                  <Link href="/cs/uk/packs">Compare Packs</Link>
                </Button>
              </div>
            </Reveal>
          </div>
              ...
              <div className="cs-retailer-card cs-retailer-card--primary flex h-full flex-col">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="flex items-center gap-3 text-base text-white/65">
                    ...
                    <span>All 6 packs in stock</span>
                  </div>
                </div>
        ...
        <Container className="relative z-10">
          <Reveal>
            ...
            <p className="mx-auto mt-3 max-w-md text-center text-base text-white/45">
              Every sheet is 12ft x 9ft. Choose the pack that fits your project.
            </p>
          </Reveal>
        ...
        <Container className="relative z-10">
          <Reveal>
            ...
            <p className="mx-auto mt-3 max-w-lg text-center text-base text-white/45">
              See how Caelum Star compares to standard dust sheets.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
              <div className="cs-glass-card flex items-center gap-3">
                ...
                <span className="text-base text-white/80">All dust sheets: 12ft x 9ft (3.6m x 2.7m)</span>
              </div>
              <div className="cs-glass-card flex items-center gap-3">
