              ...
              <Reveal delay={150}>
                <div className="space-y-5 text-base leading-relaxed text-white/55 2xl:text-lg">
                  <p className="text-lg text-white/70">
                    We believe protecting your space shouldn&apos;t be complicated. One product, six pack options, honest specs — that&apos;s it.
                  </p>
                  <p>
                    Every Caelum Star sheet is extra large at 12ft x 9ft, made with 55% recycled plastic, and globally certified. We focus on what matters: coverage that works and details you can trust.
                  </p>
                  <p>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <Reveal variant="media" delay={150} className="h-full">
              <div className="cs-retailer-card flex h-full flex-col">
                ...
                <p className="mt-3 text-base leading-relaxed text-white/55">
                  Compare all six packs, check specs and pricing, then buy on Amazon with fast delivery.
                </p>
