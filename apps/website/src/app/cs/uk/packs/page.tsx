          ...
          <div className="cs-section--hero">
            ...
            <Reveal delay={140}>
              <p className="mt-5 max-w-lg text-[1.05rem] leading-relaxed text-white/60 md:text-lg 2xl:max-w-xl 2xl:text-[1.25rem]">
                Pick your coverage. Six pack options, one extra large dust sheet. Available exclusively on Amazon.
              </p>
            </Reveal>
            <Reveal delay={200}>
            ...
            <Reveal delay={280}>
              <div className="mt-10 flex flex-wrap items-center gap-3">
                ...
                >
                  <Link href="/cs">About Caelum Star</Link>
                </Button>
              </div>
            </Reveal>
          </div>
        ...
        <Container className="relative z-10">
          <Reveal>
            ...
            <p className="mx-auto mt-3 max-w-md text-center text-base text-white/45 2xl:text-lg">
              Every dust sheet is 12ft x 9ft. Choose the pack that fits your project.
            </p>
          </Reveal>
      ...
      <section className="cs-section relative overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          <div className="mx-auto mt-14 grid max-w-4xl 2xl:max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: 'Extra Large', desc: 'Every dust sheet is 12ft x 9ft — bigger than standard alternatives.' },
              ...
              { title: 'Pack Options', desc: 'From 1 dust sheet to 10 — pick the size for your project.' },
