          ...
          <div className="grid gap-10 md:grid-cols-12 md:items-center">
            <div className="md:col-span-6">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {p.primary ? <Badge className="border-accent/40 bg-accent/10">Primary</Badge> : null}
              </div>
              ...
              <div className="mt-5 flex flex-wrap items-baseline gap-3">
                ...
                {p.coverageLabel ? <div className="text-xs text-muted">{p.coverageLabel} total coverage</div> : null}
              </div>
            </div>
            ...
            <div className="md:col-span-6">
              <Card className="overflow-hidden">
                <div className="relative aspect-[4/3] bg-white">
                  <Image src={p.image.src} alt={p.image.alt} fill className="object-contain p-6" priority />
                </div>
              </Card>
            </div>
          </div>
        ...
        <Container>
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="p-6">
              ...
              <p className="mt-2 text-sm text-muted">Built for dust, paint splatter, and everyday decorating mess.</p>
            </Card>
            <Card className="p-6">
              <div className="flex items-center gap-2 text-sm font-semibold text-ink">
              ...
              <p className="mt-2 text-sm text-muted">Extra‑large sheets help you cover faster with fewer joins.</p>
            </Card>
            <Card className="p-6">
              <div className="flex items-center gap-2 text-sm font-semibold text-ink">
          ...
          <Card className="overflow-hidden">
            <div className="relative aspect-[16/9] bg-black">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                <div className="text-xs font-semibold uppercase tracking-[0.2em] text-white/70">Made for decorating</div>
            ...
            <div className="md:col-span-5">
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-muted">
                  Email <a className="font-semibold text-ink hover:underline" href={`mailto:${site.contactEmail}`}>{site.contactEmail}</a>.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-0 md:grid-cols-12">
              <div className="relative md:col-span-7">
                <div className="relative aspect-[970/600] bg-black">
                  <Image src="/images/amazon/fit-coverage.jpg" alt="Find your perfect fit" fill className="object-cover" />
                </div>
              </div>
              <div className="md:col-span-5">
                <div className="p-6">
                  ...
                  <p className="mt-2 text-sm text-muted">
                    {primary ? (
                      <>
                        Start with the <span className="font-semibold text-ink">{primary.name}</span>. It’s the pack most customers choose.
                      </>
                    ) : (
