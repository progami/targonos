...
const TooltipRoot = TooltipPrimitive.Root as React.FC<React.ComponentProps<typeof TooltipPrimitive.Root>>;
...
function Tooltip({ content, children, position = 'top', delay = 100, className, style }: SimpleTooltipProps) {
