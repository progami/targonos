...
export function SetupProductTable({ strategyId, products, className }: SetupProductTableProps) {
  ...
  return (
    <section className={cn('space-y-3', className)}>
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-sm font-semibold text-slate-900 dark:text-white">Products</h4>
          ...
          <Table className="w-full table-fixed border-collapse">
            <TableHeader>
              <TableRow className="hover:bg-transparent">
                <TableHead className={cn(headClass, 'w-32 text-left')}>SKU</TableHead>
