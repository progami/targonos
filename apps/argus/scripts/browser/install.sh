...
WPR_HERO_ASIN_ENV_KEY="WPR_HERO_ASIN_${MARKET_SUFFIX}"
...
WPR_HERO_ASIN="$(require_env_value "$WPR_HERO_ASIN_ENV_KEY")"
...
WPR_HERO_ASIN_XML="$(xml_escape "$WPR_HERO_ASIN")"
...
<dict>
  ...
  <dict>
    ...
    <key>${WPR_HERO_ASIN_ENV_KEY}</key>
    <string>${WPR_HERO_ASIN_XML}</string>
