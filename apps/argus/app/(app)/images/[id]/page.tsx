...
export default async function ImageManagerDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="space-y-6">
      <ProductDetailHeader
        target={{
          ...
          activeImageVersionNumber: target.activeImageVersion ? target.activeImageVersion.versionNumber : null,
        }}
        activeTab="images"
        backHref="/images"
        backLabel="Image Manager"
      />
