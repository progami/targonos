-- ERD v10.1 compatibility views for Talos purchase-order flow.
-- Changes from v10: lot gains po_id/carton overrides/status; rfq/purchase_order
-- replace is_cancelled with status; commercial_invoice/grn/grn_line_item gain status.
