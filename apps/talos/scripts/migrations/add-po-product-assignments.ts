...
function showHelp() {
  console.log(`
Add PO Product Assignments

Creates po_product_assignments for manufacturing-stage product-based PO access.

Usage:
  pnpm --filter @targon/talos tsx scripts/migrations/add-po-product-assignments.ts [options]
...
async function applyForTenant(tenant: TenantCode, options: ScriptOptions) {
  ...
  console.log(`\n[${tenant}] Ensuring po_product_assignments exists`)
