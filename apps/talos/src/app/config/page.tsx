...
import { Building, DollarSign, Users, ArrowRight } from '@/lib/lucide-icons'
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Set up master data and system configurations</p>
        </div>
        ...
        <div className="border rounded-lg p-6 bg-amber-50">
          ...
          <ul className="space-y-1 text-sm text-slate-700">
            <li>
              • Maintain SKU reference data in <strong>Amazon → SKU Info</strong>
            </li>
            <li>
              • Maintain <strong>Suppliers</strong> so teams pick consistent names
            </li>
            <li>
              • Configure <strong>Cost Rates</strong> for accurate billing
            </li>
            <li>
              • Keep <strong>Warehouses</strong> information updated
            </li>
          </ul>
        </div>
      </div>
