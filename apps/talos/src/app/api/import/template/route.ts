...
function getFieldDescription(dbField: string, entityName: string): string {
  const descriptions: Record<string, Record<string, string>> = {
    ...
    suppliers: {
      ...
      defaultIncoterms: 'Default Incoterms (e.g., OutboundB, CIF, EXW, DDP)',
    },
    costRates: {
    ...
    inventoryTransactions: {
      ...
      lotRef: 'Lot reference (auto-generated for Inbound lots; required for inventory)',
      referenceId: 'Reference ID (Inbound number, SO number, email tag, etc.)',
