  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed left-1/2 top-[15%] w-full max-w-xl -translate-x-1/2">
        <div className="mx-4 overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-2xl">
          {/* Search Input */}
          <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-700 dark:border-slate-700 px-4 py-3">
