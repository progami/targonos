...
export function PageHeaderSection({
 ...
 return (
 <header className="sticky top-0 z-10 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/95 px-4 py-4 shadow-soft backdrop-blur-xl sm:px-6 lg:px-8">
